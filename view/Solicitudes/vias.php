    ...
    <form action="<?php echo getUrl("Solicitudes", "Solicitudes", "regVias"); ?>" method="POST"
        ...
        <div class="row">
            ...
            <div class="col-md-4 mt-3">
                ...
                <input type="number" id="numeroPrincipal" name="numeroPrincipal" class="form-control" placeholder="123"
                    min="1" max="300">
            </div>
            <div class="col-md-4 mt-3">
            ...
            <div class="col-md-4 mt-3">
                ...
                <input type="number" id="numeroSecundario" name="numeroSecundario" class="form-control" placeholder="22"
                    min="1" max="300" maxlength="3">
            </div>
            <div class="col-md-4 mt-3">
            ...
            <div class="col-md-4 mt-3">
                ...
                <input type="number" id="numeroTerciario" name="numeroTerciario" class="form-control" placeholder="42"
                    min="1" max="300" maxlength="3">
            </div>
